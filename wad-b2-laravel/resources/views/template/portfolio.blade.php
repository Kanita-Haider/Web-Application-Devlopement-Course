	...
	<div class="container-fluid p-0">
                <div class="row no-gutters">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{asset('template/assets/img/portfolio/fullsize/1.jpg')}}">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{asset('template/assets/img/portfolio/fullsize/2.jpg')}}">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{asset('template/assets/img/portfolio/fullsize/3.jpg')}}">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{asset('template/assets/img/portfolio/fullsize/4.jpg')}}">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{asset('template/assets/img/portfolio/fullsize/5.jpg')}}">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{asset('template/assets/img/portfolio/fullsize/6.jpg')}}">
